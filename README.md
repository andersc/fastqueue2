...
|---|---:|---|---|---|
| Intel Xeon E5-2630L v3 | all 32 allowed logical CPUs; `32 × 31 = 992` ordered paths | Scalar + fixed 1–8 | complete; 44,640 rows; hard-pinned | [scalar heatmap](docs/topology-matrix/linux-runs/fq-topology-f061-20260718-194430/scalar-heatmap.png) · [fixed-8 heatmap](docs/topology-matrix/linux-runs/fq-topology-f061-20260718-194430/fixed-8-heatmap.png) · [3D topology heat cube](docs/topology-matrix/linux-runs/fq-topology-f061-20260718-194430/topology-voxel-cube.png) · [cube cell coverage](docs/topology-matrix/linux-runs/fq-topology-f061-20260718-194430/topology-voxel-cube-coverage.json) · [raw CSV](docs/topology-matrix/linux-runs/fq-topology-f061-20260718-194430/results.csv) · [median summary](docs/topology-matrix/linux-runs/fq-topology-f061-20260718-194430/summary.json) · [metadata](docs/topology-matrix/linux-runs/fq-topology-f061-20260718-194430/metadata.json) · [width chart](docs/topology-matrix/linux-runs/fq-topology-f061-20260718-194430/width-depth.png) |
